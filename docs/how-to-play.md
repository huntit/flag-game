...
- **Flag's tile set:**
  - ✅ **Letter values** locked from Word Eagle WWF default (see [docs/assets.md](assets.md))
  - ⏳ **Bag distribution** pending (not in Word Eagle, which is a seed-word puzzle, not a bag game)
