...
**Steal the corner. A two-player crossword game.** — Private prototype repository
...
**Play it:** https://huntit.github.io/wordheist-game/ — built for iPhone Safari, Add to Home Screen for the feel-test.
...
Word Heist is a distinct game, not a variant of commercial crossword products:

- **Custom dictionary and tile set** — Word Heist uses Peter's custom ENABLE-based word list and a ~⅔ WWF English bag (69 tiles) paired with Word Eagle's WWF letter values, not third-party crossword publisher data
...
- **Lab simulation** — Headless AI vs AI matchups for game balance analysis (`wordheist-sim --games 200 --p1 greedy --p2 hunter`)
